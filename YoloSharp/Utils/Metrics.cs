...
namespace Utils
{
	internal class Metrics
	{
		...
		internal static Tensor batch_probiou(Tensor obb1, Tensor obb2, float eps = 1e-7f)
		{
			...
			var x1 = obb1[.., 0].unsqueeze(-1);
			var y1 = obb1[.., 1].unsqueeze(-1);
			var x2 = obb2[.., 0].unsqueeze(0);
			var y2 = obb2[.., 1].unsqueeze(0);

			var (a1, b1, c1) = _get_covariance_matrix(obb1);
			var (a2, b2, c2) = _get_covariance_matrix(obb2);
