...
namespace YoloSharp.Models
{
    internal class Yolo
    {
        ...
        public class Yolov8 : Module<Tensor, Tensor[]>
        {
            ...
            public Yolov8(int nc = 80, YoloSize yoloSize = YoloSize.n, Device? device = null, torch.ScalarType? dtype = null, int? kpt_num = null, int? kpt_dim = null) : base(nameof(Yolov8))
            {
        ...
        public class Yolov11 : Yolov8
        {
            ...
            public Yolov11(int nc = 80, YoloSize yoloSize = YoloSize.n, Device? device = null, torch.ScalarType? dtype = null, int? kpt_num = null, int? kpt_dim = null) : base(nc, yoloSize, device, dtype, kpt_num: kpt_num, kpt_dim: kpt_dim)
            {
        ...
        {
            public Yolov8Pose(int nc = 80, int? kpt_num = null, int? kpt_dim = null, YoloSize yoloSize = YoloSize.n, Device? device = null, torch.ScalarType? dtype = null) : base(nc, yoloSize, device, dtype, kpt_num: kpt_num, kpt_dim: kpt_dim)
            {
            ...
            internal override ModuleList<Module> BuildModel(int nc, YoloSize yoloSize, Device? device, torch.ScalarType? dtype)
            {
                var mod = base.BuildModel(nc, yoloSize, device, dtype);
                mod.RemoveAt(mod.Count - 1); // remove Detect
                mod.Add(new Pose(nc: nc, kpt_num: this.kpt_num, kpt_dim: this.kpt_dim, ch: ch, device: device, dtype: dtype));
                return mod;
            }
        }
        ...
        {
            public Yolov11Pose(int nc = 80, int? kpt_num = null, int? kpt_dim = null, YoloSize yoloSize = YoloSize.n, Device? device = null, torch.ScalarType? dtype = null) : base(nc, yoloSize, device, dtype, kpt_num: kpt_num, kpt_dim: kpt_dim)
            {
            ...
            internal override ModuleList<Module> BuildModel(int nc, YoloSize yoloSize, Device? device, torch.ScalarType? dtype)
            {
                var mod = base.BuildModel(nc, yoloSize, device, dtype);
                mod.RemoveAt(mod.Count - 1); // remove Detect
                mod.Add(new Pose(nc: nc, kpt_num: kpt_num, kpt_dim: kpt_dim, ch: ch, device: device, dtype: dtype));
                return mod;
            }
        }
